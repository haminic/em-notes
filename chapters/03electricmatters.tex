...
สำหรับการปล่อยสนาม $\vb{E}$ นี้ไปบนโมเลกุล การเหนี่ยวนำ dipole จะต่างกันเล็กน้อย เพราะโมเลกุลนี้อาจจะถูกโพลาไรซ์ยากง่ายไม่เท่ากันในแกนที่ต่างกัน เช่นในตัวอย่างง่าย ๆ อย่าง $\mathrm{CO}_2$ ที่โมเลกุลมีรูปร่างเป็นเส้นตรง เมื่อปล่อยสนามผ่านโมเลกุลในทิศเอียงจะต้องคิด dipole moment แยกเป็นสองพจน์:
\[
...
\subsection{สภาพอ่อนไหว, สภาพยอม, ค่าคงที่ไดอิเล็กทริก}
...
\begin{ieqbox}{พลังงานในสนามไฟฟ้าที่มีไดอิเล็กทริก}
    U=\frac{1}{2} \int \ab(\vb{D}\cdot\vb{E})\odif{\tau}\label{edensitydi}
\end{ieqbox}
...
\end{eqbox}
หมายเหตุ: \emph{เมื่อ $x=0$ ไม่ได้ทำให้ $F=0$ เพราะการใช้ $U$ เป็นค่านั้นเป็นการประมาณสำหรับ $x$ ที่มีค่ามาก ๆ}