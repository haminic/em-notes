...
\begin{align*}
    \vb{A}(\vb{r}) &= \frac{\mu_0}{4\pi}\oint \frac{1}{\rad}\odif{\vbs{\ell}'}\\
    &=\frac{\mu_0}{4\pi} \sum_{n=0}^{\infty}\frac{1}{r^{n+1}}\oint\ab(r')^nP_n(\cos\alpha)\odif{\vbs{\ell}'}
\end{align*}
ก็จะได้พจน์
\[
\vb{A}_\txt{mon}(\vb{r}) = \frac{\mu_0}{4\pi r}\oint\odif{\vbs{\ell}'} = \vb{0}
\]
ตามที่คาด (เพราะจาก (\ref{gaussb}) เราสมมติไม่มี magnetic monopole)\\
ต่อมาเรามาดูพจน์ dipole:
\begin{align*}
    \vb{A}_\txt{dip}(\vb{r}) &= \frac{\mu_0}{4\pi r^2}\oint r'\cos\alpha\odif{\vbs{\ell}'}\\
    &= \frac{\mu_0}{4\pi r^2}\oint\ab(\vu{r}\cdot\vb{r}')\odif{\vbs{\ell}'}\\
    &= 
\end{align*}