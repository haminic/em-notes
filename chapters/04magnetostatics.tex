...
\[
\odif{W}_\txt{mag}=\vb{F}_\txt{mag}\cdot\odif{\vbs{\ell}}=Q(\vb{v}\times\vb{B})\cdot\vb{v}\odif{t}=0
\]
ดังนั้นได้ว่า
...
หรือก็คือ
\begin{equation}
    \vb{F}_\txt{mag}=\int\ab(I\odif{\vbs{\ell}}\times\vb{B})
\end{equation}
...
\end{enumerate}
สรุปก็คือ
\begin{lawbox}{สภาวะขอบเขตของ B และ A เมื่อผ่านแผ่นกระแส}
