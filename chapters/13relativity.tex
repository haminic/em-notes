...
\begin{defbox}{โมเมนตัมเชิงสัมพัทธภาพ}
    \begin{equation}
        \vb{p} \equiv m\vbs{\upeta} = \frac{m\vb{u}}{\sqrt{1-u^2/c^2}}
    \end{equation}
\end{defbox}
...
โดยเช่นเดียวกับกลศาสตร์ดั้งเดิม เราจะเรียกการชนที่อนุรักษ์พลังงานจลน์ (และสุดท้ายจะอนุรักษ์มวลด้วย) ว่าเป็น\emph{การชนแบบยืดหยุ่น}

\subsection{การกระเจิง Compton}