...
\begin{eqbox}{สนามไฟฟ้าของจุดประจุ}
    \vb{E}(\vb{r})=\kem\sum_{\vb{r}_k\neq\vb{r}}q_k\frac{\vb{r}-\vb{r}_k}{\abs{\vb{r}-\vb{r}_k}^3}=\kem\sum_k\frac{q_k}{\nrr_k^2}\vrru_k
\end{eqbox}
...
\begin{eqbox}{สนามไฟฟ้าของประจุต่อเนื่อง}
    \vb{E}(\vb{r})=\kem\int\frac{\rho(\vb{r}')}{\nrr^2}\vrru\odif{\tau'}
\end{eqbox} 
...
\begin{eqbox}{ศักย์ไฟฟ้าของประจุต่อเนื่อง}
     V(\vb{r})=\kem\int\frac{\rho(\vb{r}')}{\nrr}\odif{\tau'}\label{potentialcont}
\end{eqbox}
